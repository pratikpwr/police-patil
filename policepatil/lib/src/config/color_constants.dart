...
const Color PRIMARY_COLOR =
    Colors.blue; //Color(0xff000eac); // police blue color //Color(0xffdacbb0)
...
const Color TEXT_COLOR_TITLE = Color(0xff424242);
const Color TEXT_COLOR_SUBTITLE = Color(0xff424242);
